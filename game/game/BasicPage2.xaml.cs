...
namespace game
{
    ...
    public sealed partial class BasicPage2 : Page
    {
       ...
       private void Image_DoubleTapped_3(object sender, DoubleTappedRoutedEventArgs e)
       {
           Frame.Navigate(typeof(BasicPage7));
       }

       private void Image_DoubleTapped_4(object sender, DoubleTappedRoutedEventArgs e)
       {
           Frame.Navigate(typeof(BasicPage8));
       }
